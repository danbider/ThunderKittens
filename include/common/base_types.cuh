...
template<typename T> struct constants {
    ...
    /**
     * @brief Negative One
     * @return Constexpr negative one with type T
     */
    static __device__ inline constexpr T neg_one()       { return T{-1}; }
    /**
...
template<> struct constants<float2> {
    ...
    static __device__ inline constexpr float2 neg_one()       { return float2{-1.f, -1.f}; }
...
template<> struct constants<bf16> {
    ...
    static __device__ inline constexpr bf16 neg_one()   { return std::bit_cast<__nv_bfloat16>(uint16_t(0xBF80)); }
...
template<> struct constants<bf16_2> {
    ...
    static __device__ inline constexpr bf16_2 neg_one()       { return bf16_2{constants<bf16>::neg_one(),       constants<bf16>::neg_one()};       }
...
template<> struct constants<half> {
    ...
    static __device__ inline constexpr half neg_one()   { return std::bit_cast<__half>(uint16_t(0xBC00)); }
...
template<> struct constants<half_2> {
    ...
    static __device__ inline constexpr half_2 neg_one()   { return half_2{constants<half>::neg_one(),       constants<half>::neg_one()};       }
